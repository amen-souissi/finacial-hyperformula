...
export class DecimalNumeric implements Numeric {
  ...
  /**
   * Returns atan2(this, x) - the angle between the positive x-axis and the point (x, this).
   */
  atan2(x: Numeric): Numeric {
    // Decimal.js uses Decimal.atan2(y, x) static method
    return new DecimalNumeric(Decimal.atan2(this.value, (x as DecimalNumeric).value))
  }
  /**
   *
   */
